                ...
                <form action="" method="post">
                    <div class="form-row">
                        ...
                        <div class="form-group col pl-2">
                            <input class="form-control col-md-10" name="datetimepicker1" id="datetimepicker2" date-picker-example type="text" data-provide="datepicker" data-date-language="th-th" data-date-format="dd/mm/yyyy" value="<?php echo $date ?>" placeholder="xx/xx/xxxx" autocomplete="off">
                        </div>
              ...
              <div class="col-md-12">
                    <div class="card">
                        ...
                        <table align="center">
                                        ...
                                        if($num > 0){
                                        $sql ="SELECT login_date.Username, user.Firstname, user.Lastname , login_date.Lastdate FROM login_date INNER JOIN user ON login_date.Username=user.Username WHERE login_date.Lastdate = '$datetimepicker1'  ORDER BY `Lastdate` DESC";
                                        // echo $sql;
                                        $query = mysqli_query($conn,$sql);
