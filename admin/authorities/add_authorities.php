                                        ...
                                        <div class="card-body" align="center">
                                            <form action="./insert.php" method="POST">
                                                <div class="form-group col-md-6 ">
                                                    ...
                                                    <input type="text" class="form-control" name="user_name" id="Username" aria-describedby="emailHelp" placeholder="Username" required>
                                                    <small id="emailHelp" class="form-text text-muted">รหัสบัตรประชาชน 13 หลัก </small>
                                                </div>
                                                <div class="form-group col-md-6">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" id="firstname" name="first_name" placeholder="ชื่อ" required>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="exampleInputPassword1">เบอร์โทรศัพท์ที่สามารถติดต่อได้</label>
