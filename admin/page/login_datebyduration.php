                        ...
                        <div class="table-responsive-md">
                          <table align="center" class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $d['Lastdate'];?></td>
                                            <td align="right"><?php echo $d["time"];?></td>
                                            <td align="right"> <a href="./del3.php?ID=<?php echo $d['ID']; ?>" class="btn btn-danger">ลบ</a></td>
                                        </tr>
                                        <?php
                                          }
                                          }
                                        ...
                                        <tr>
                                            ...
                                            <td><div align="center"><?php echo $d['Firstname'] ." ".$d["Lastname"];?></div></td>
                                            <td><?php echo $d[3];?></td>
                                            <td align="right"><?php echo $d['Lastdate'];?></td>
                                            <td align="right"> <a href="./deluser3.php?ID=<?php echo $d['ID']; ?>" class="btn btn-danger">ลบ</a></td>
                                        </tr>
                                        <?php
                                        }}
                                        $count++;
