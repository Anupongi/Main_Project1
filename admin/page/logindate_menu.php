                ...
                <div class="col-md-10">
                    <div class="form-row text-center " style="BORDER-BOTTOM: #b7deff 1px dashed;BORDER-TOP: #b7deff 1px dashed;BORDER-LEFT: #b7deff 1px dashed;BORDER-RIGHT: #b7deff 1px dashed;">
                        ...
                        <div class="col pt-4 pb-4">
                            <a href="./login_datebyduration.php" class="btn" style="background-color:Orange;color:white;">ค้นหาจากช่วงวันที่</a>
                        </div>
                        <div class="col pt-4 pb-4">
                            <a href="./login_datebydate.php" class="btn" style="background-color:hsl(147, 50%, 47%);color:white;">ค้นหาจากวันที่</a>
                        </div>
                        <div class="col pt-4 pb-4">
                            <a href="./login_datebyname.php" class="btn" style="background-color:Tomato;color:white;">ค้นหาจากชื่อผู้ใช้</a>
                        </div>
                        ...
                        <div class="card-body">
                          <div class="table-responsive-md">
                            <table align="center" class="table">
                                ...
                                <?php
                                $conn = mysqli_connect("localhost","root","itcmtc2019","user_login");
                                mysqli_set_charset($conn, "utf8");
                                $sql ="SELECT login_date.ID,login_date.Username, user.Firstname, user.Lastname , login_date.Lastdate,login_date.time FROM login_date INNER JOIN user ON login_date.Username=user.Username  ORDER BY `login_date`.`ID` DESC";
                                // echo $sql;
                                $query = mysqli_query($conn,$sql);
                                $count = 0;
                                ...
                                ?>
                                    <tr>  
                                        ...
                                        <td align="right"> <a href="./del1.php?ID=<?php echo $d['ID']; ?>" class="btn btn-danger">ลบ</a></td>
                                    </tr>
                                <?php
                                }
                                ?>
                            ...
                            <div class="row">
                                <div class="col-9"></div>
                                <div class="col-3">
                                    <a href="../Exportfile/export1.1.php" class="btn btn-success"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Export to Excel</a>
                                </div>
                            </div>
                        </div>    
