              ...
              <div class="col-12">
                    <div class="card">
                        <div class="card-header text-center">
                            <h5>รายชื่อการลงชื่อเข้าใช้ประจำวัน</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <table align="center">
                                        ...
                                        <?php
                                        $sql1 = "SELECT login_date.ID,login_date.Username,login_date.Lastdate,user.Firstname, user.Lastname FROM user INNER JOIN login_date ON user.Username=login_date.Username WHERE login_date.`Lastdate` = '$date'";
