...
if(isset($_POST['id_user'])){  
  ...
  $sql = "SELECT * FROM `login_date` WHERE `Username`='$id_user'";
                ...
                <form action="" method="post">
                    <div class="form-row">
                        ...
                        <div class="form-group col pl-4">
                            <input type="text" name="id_user" id="" class="form-control" placeholder="รหัสผู้ใช้" autocomplete="off">
                        </div>
                        ...
                        <div class="card-body">
                          <div class="table-responsive-md">
                            <table align="center" class="table">
                                        ...
                                        if($num > 0){
                                        $sql ="SELECT login_date.ID,login_date.Username, user.Firstname, user.Lastname , login_date.Lastdate,login_date.time FROM login_date INNER JOIN user ON login_date.Username=user.Username WHERE login_date.Username = '$id_user'  ORDER BY `Lastdate` DESC";
                                        // echo $sql;
                                        $query = mysqli_query($conn,$sql);
                                        ...
                                        <?php
                                          ...
                                          $sql ="SELECT login_date.ID,login_date.Username, user.Firstname, user.Lastname , login_date.Lastdate,login_date.time FROM login_date INNER JOIN user ON login_date.Username=user.Username ORDER BY `Lastdate` DESC ";
                                          // echo $sql;
                                          $query = mysqli_query($conn,$sql);
                                          while ($d = mysqli_fetch_array($query)) {
                                            $count = $count + 1;
