...
<head>
  ...
  <title>รายการข้อมูลเวชภัณฑ์ยา อุปกรณ์ทางการแพทย์ | Dashboard</title>
              ...
              <div class="col-12">
                    <div class="card">
                        <div class="card-header text-center">
                            <h5>รายชื่อเวชภัณฑ์ ยา และอุปกรณ์ทางการแพทย์</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                  <div class="table-responsive-xl">
                                    <table align="center">
                                        ...
                                        <tr>
                                            ...
                                            <td><div align="center"><?php echo $result["med_fullname"] ;?></div></td>
                                            ...
                                            <td align="right"> <a href="./delmed.php?ID=<?php echo $result[0]; ?>" class="btn btn-danger">ลบ</a></td>
                                        </tr>
                                        <?php
                                        $count=$count+1;
                                        }
