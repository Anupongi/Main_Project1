                        ...
                        <div class="table-responsive-md">
                          <table align="center" class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $d['Lastdate'];?></td>
                                            <td align="right"><?php echo $d["time"];?></td>
                                            <td align="right"> <a href="./del3.php?ID=<?php echo $result['ID']; ?>" class="btn btn-danger">ลบ</a></td>
                                        </tr>
                                        <?php
                                          }
                                          }
                                        ...
                                        <tr>
                                            ...
                                            <td align="right"> <a href="./deluser3.php?ID=<?php echo $result[0]; ?>" class="btn btn-danger">ลบ</a></td>
                                        </tr>
                                        <?php
                                        }}
                                        $count++;
