                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive-md">
                          <table align="center"  class="table">
                                        ...
                                        if($num > 0){
                                        $sql ="SELECT login_date.ID,login_date.Username, user.Firstname, user.Lastname , login_date.Lastdate ,login_date.time FROM login_date INNER JOIN user ON login_date.Username=user.Username WHERE login_date.Lastdate = '$datetimepicker1'  ORDER BY `Lastdate` DESC";
                                        // echo $sql;
                                        $query = mysqli_query($conn,$sql);
                                        ...
                                        <tr>
                                            ...
                                            <td align="right"> <a href="./del4.php?ID=<?php echo $d['ID']; ?>" class="btn btn-danger">ลบ</a></td>
                                        </tr>
                                        <?php
                                        }
                                        }else{
				                            ...
				                            echo "window.location='./login_datebydate.php';";
			                                echo "</script>";
                                        }
                                        }
                                        else{
