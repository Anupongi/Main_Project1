...
$id = $_GET['ID'];
$sql = "SELECT * FROM tb_med WHERE `med_id` = $id" ;
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <?php
            ...
            $query1 = mysqli_query($con,$sqlimg);
              ...
              <div class="col-12">
                    <div class="card">
                        <div class="card-header text-center">
                            <h5>เพิ่มข้อมูลเวชภัณฑ์ยา และอุปกรณ์ทางการแพทย์</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-3"></div>
                                        ...
                                        <div class="card-body" align="center">
                                            <form action="./update.php" method="POST">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="med_fullname" name="med_fullname" placeholder="ชื่อทางการ" value="<?php echo $array[2]?>">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="total" name="total" placeholder="จำนวน" value="<?php echo $array[3]?>">
                                                </div>
