                  ...
                  <label for="exampleInputFile">รูปภาพ</label>
                    <div class="input-group">
                      ...
                      <div class="input-group-append">
                       ...
                       </div><!--<input type="text" value="image"> -->
                    </div>
                </div>
                <div class="form-group">
                  <label for="title">เนื้อหา</label>
                    <textarea name="editor1" ><?php echo $array[3] ?></textarea>
                </div>  
                
                  <!-- <a href="./editpage/update.php?id=<?php echo $d[0] ?>" class="btn btn-primary">ยืนยัน</a> -->
