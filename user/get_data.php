<?php
    ...
    if(isset($_GET['amphur_id'])){
        ...
        $sql = "SELECT zipcode.ZIPCODE_ID,zipcode.ZIPCODE,district.DISTRICT_CODE,district.DISTRICT_NAME FROM `district` INNER JOIN `zipcode` ON district.DISTRICT_ID = zipcode.DISTRICT_ID WHERE district.`AMPHUR_ID` = '".$amphur_id."'";
        //$sql = "SELECT zipcode.ZIPCODE_ID,zipcode.ZIPCODE,district.DISTRICT_CODE,district.DISTRICT_NAME FROM district INNER JOIN zipcode  ON zipcode.AMPHUR_ID=district.AMPHUR_ID WHERE zipcode.AMPHUR_ID = '".$amphur_id."' ";
        //$sql = "SELECT zipcode.ZIPCODE_ID,zipcode.ZIPCODE,district.DISTRICT_CODE,district.DISTRICT_NAME FROM district WHERE district.AMPHUR_ID = '".$amphur_id."' ";
        //ประมวณผลคำสั่ง SQL
        $result = $conn->query($sql);
