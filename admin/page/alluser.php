...
<html>
 ...
 <?php
   ...
   mysqli_set_charset($conn, "utf8");
	$sql = "SELECT `ID`,`Username`, `Password`, `Firstname`, `Lastname`, `Userlevel`, `date` FROM user WHERE Userlevel IN ('02', '03') ";
...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			<h1 class="text-center">รายชื่อผู้สมัครสมาชิกทั้งหมด</h1>
			<div class="card">
				<div class="card-body">
						...
						<table align="center">
							...
							<tbody>
								<tr>
									...
									<td align="right"> <a href="./deluser.php?ID=<?php echo $result['ID']; ?>" class="btn btn-danger">ลบ</a></td>
								</tr>
								<?php
									$count=$count+1;
									}
