...
$sql = "SELECT * FROM `login_date` WHERE  Username='".$name."' ";
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./list_login.php" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                                ...
                                <div class="col-md-12">
                                  <div class="table-responsive-md">
                                    <table align="center" class="table">
                                        ...
                                        <?php
                                         mysqli_set_charset($conn, "utf8");
                                         $sql1 = "SELECT login_date.Username,login_date.Lastdate,login_date.time,user.Firstname, user.Lastname FROM login_date INNER JOIN user ON user.Username=login_date.Username WHERE login_date.Username='".$name."' ORDER BY Lastdate DESC ";
